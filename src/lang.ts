const lang = {
  ...
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use Yomi app on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts',
  ...
  'Deactivated.Subtitle': 'Yomi supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on Yomi Web. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on Yomi Web. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use Yomi on all your devices at once.',
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on Yomi Web. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on Yomi Web. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive Yomi Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive Yomi Premium.'
  },
  'BoostsViaGifts.Duration': 'Duration of premium subscriptions',
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for Yomi Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, Yomi will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, Yomi automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, Yomi will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, Yomi automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, Yomi will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, Yomi automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, Yomi will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, Yomi automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by Yomi and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by Yomi and received private messages with giftcodes.'
  },
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to Yomi Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** Yomi Premium subscription for %s',
    'other_value': '**%d** Yomi Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with Yomi Premium subscription for %s',
    'other_value': '**%d** %s with Yomi Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'Yomi Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'Yomi Premium subscriptions for %s',
  ...
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to Yomi Premium.',
  ...
  'Boost.GiftPremium': '**[gift Yomi Premium]()**',
  'Boost.Additional': {
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to Yomi Premium to restrict who can send you voice or video messages.\n\n**[What is Yomi Premium?]()**',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'Yomi doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on Yomi only if they are your contacts.',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your Yomi account. There will be no way to restore it.',
  ...
  'TelegramFeatures': 'Yomi Features',
  ...
  'NoUsernameFound': 'There is no Yomi account with this username.',
  ...
  'ReportSentInfo': 'Yomi moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official Yomi app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. Yomi has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that Yomi never stores your credit card data.',
  ...
  'TerminateWebSessionInfo': 'Click to disconnect from your Yomi account.',
  ...
  'GiftTelegramPremiumTitle': 'Gift Yomi Premium',
  ...
  'ActionGiftPremiumTitle': 'Yomi Premium',
  ...
  'ChannelAntiSpamInfo': 'Yomi will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has Yomi installed will be able to join your channel by following this link.',
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of Yomi Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** Yomi Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Yomi Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s Yomi Premium** subscriptions for %4$s for its followers.'
  },
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Yomi Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s Yomi Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingDate': 'Date',
  'BoostingTelegramPremiumFor': 'Yomi Premium for %s',
  ...
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to Yomi Premium.',
  'TelegramPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to Yomi Premium.',
  ...
  'GiftPremiumActivateErrorTitle': 'You already have Yomi Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to Yomi Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to Yomi Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a Yomi Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to Yomi Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to Yomi Premium',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on Yomi yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using Yomi search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using Yomi search.',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, Yomi never uses your private data to target ads. Sponsored messages on Yomi are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on Yomi sees the same sponsored messages.\n\nUnlike other apps, Yomi doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nTelegram offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, Yomi developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow Yomi to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to Yomi Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make Yomi look amazing.',
  ...
  'PrivacyAndSecurity.SensitiveDesc': 'Display sensitive media in public channels on all your Yomi devices.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through Yomi servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your Yomi account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where Yomi sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to Yomi Premium.',
  ...
  'Premium.Boarding.Title': 'Yomi Premium',
  ...
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to Yomi Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nTelegram Premium',
  'Premium.Boarding.Peer.Info': 'Owners of Yomi Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About Yomi Premium',
  'Premium.Boarding.About.Text': 'While the free version of Yomi already gives its users more than any other messaging application, **Telegram Premium** pushes its capabilities even further.\n\n**Telegram Premium** is a paid option, because most Premium Features require additional expenses from Yomi to third parties such as data center providers and server manufacturers. Contributions from **Telegram Premium** users allow us to cover such costs and also help Yomi stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the Yomi [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for Yomi Premium.',
  'Premium.Boarding.Subscribe': 'Subscribe for %@ per month',
  'Premium.Offset.AlreadyHave': 'You already have Yomi Premium.',
